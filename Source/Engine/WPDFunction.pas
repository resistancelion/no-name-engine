...
uses Windows, Messages, SysUtils, Classes, vcl.Dialogs, vcl.Graphics,
  vcl.Forms, ZendTypes, PHPTypes, zendAPI, Variants, rtti, WideStrUtils,
  DelphiPhp5;
...
begin
  ...
  try
    ...
    ZendAlterIniEntry('max_execution_time', '0', ZEND_INI_SYSTEM,
...
begin
  ...
  try
    ...
    file_handle.free_filename := false;
...
begin
  ...
  begin
    ...
    ZendAlterIniEntry('register_argc_argv', '0', ZEND_INI_SYSTEM,
      ZEND_INI_STAGE_ACTIVATE);
    ZendAlterIniEntry('html_errors', '1', ZEND_INI_SYSTEM,
      ZEND_INI_STAGE_ACTIVATE);
    ZendAlterIniEntry('implicit_flush', '1', ZEND_INI_SYSTEM,
      ZEND_INI_STAGE_ACTIVATE);
    ZendAlterIniEntry('max_input_time', '0', ZEND_INI_SYSTEM,
      ZEND_INI_STAGE_ACTIVATE);
  end;
end;
