...
typedef struct {
	int (*_FindControlVCL)(const char* obj);
	int (*_TestVariant)(zval* ZResult, int ZOwner, int ZOwnerSelf, const char* Name, void *arr);
	void (*_RttiMessage)(const char*  var);
} TEventBase;
...
ZEND_API TEventBase *_TestCreate;
END_EXTERN_C()
