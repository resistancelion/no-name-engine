...
/* Line 189 of yacc.c  */
#line 343 "Zend/zend_ini_parser.c"
...
/* Line 264 of yacc.c  */
#line 402 "Zend/zend_ini_parser.c"
...
{
       0,   287,   287,   288,   292,   299,   307,   320,   321,   325,
     326,   330,   331,   332,   333,   334,   338,   339,   343,   344,
     345,   349,   350,   351,   352,   353,   354,   358,   359,   360,
...
/* Line 1455 of yacc.c  */
#line 292 "Zend/zend_ini_parser.y"
    {
#if DEBUG_CFG_PARSER
			printf("SECTION: [%s]\n", Z_STRVAL((yyvsp[(2) - (3)])));
#endif
...
/* Line 1455 of yacc.c  */
#line 299 "Zend/zend_ini_parser.y"
    {
#if DEBUG_CFG_PARSER
...
/* Line 1455 of yacc.c  */
#line 307 "Zend/zend_ini_parser.y"
    {
#if DEBUG_CFG_PARSER
...
/* Line 1455 of yacc.c  */
#line 320 "Zend/zend_ini_parser.y"
...
/* Line 1455 of yacc.c  */
#line 325 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 326 "Zend/zend_ini_parser.y"
...
/* Line 1455 of yacc.c  */
#line 331 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 332 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 333 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 339 "Zend/zend_ini_parser.y"
    { zend_ini_init_string(&(yyval)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 344 "Zend/zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); zend_string_free(Z_STR((yyvsp[(2) - (2)]))); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 345 "Zend/zend_ini_parser.y"
    { zend_ini_init_string(&(yyval)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 350 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 351 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(2) - (3)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 352 "Zend/zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); zend_string_free(Z_STR((yyvsp[(2) - (2)]))); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 359 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 360 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(2) - (3)]); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 361 "Zend/zend_ini_parser.y"
    { zend_ini_add_string(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)])); zend_string_free(Z_STR((yyvsp[(2) - (2)]))); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 368 "Zend/zend_ini_parser.y"
...
/* Line 1455 of yacc.c  */
#line 369 "Zend/zend_ini_parser.y"
    { zend_ini_do_op('&', &(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(3) - (3)])); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 370 "Zend/zend_ini_parser.y"
    { zend_ini_do_op('^', &(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(3) - (3)])); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 382 "Zend/zend_ini_parser.y"
...
/* Line 1455 of yacc.c  */
#line 383 "Zend/zend_ini_parser.y"
...
/* Line 1455 of yacc.c  */
#line 384 "Zend/zend_ini_parser.y"
...
/* Line 1455 of yacc.c  */
#line 390 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_RAW: '%s'\n", Z_STRVAL($1));*/ ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 391 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_NUMBER: '%s'\n", Z_STRVAL($1));*/ ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 392 "Zend/zend_ini_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); /*printf("TC_STRING: '%s'\n", Z_STRVAL($1));*/ ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 2019 "Zend/zend_ini_parser.c"
      default: break;
    }
